...
Deno.test("RgbColor.prototype.toRgb()", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
  const c1r = c1.toRgb();
  ...
  const c2 = RgbColor.fromRgb({ r: 0, g: 128, b: 64, a: 0.6 });
  const c2r = c2.toRgb();
...
Deno.test("RgbColor.prototype.toRgb({}) - discardAlpha:true", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
...
Deno.test("RgbColor.prototype.toRgb({}) - omitAlphaIfOpaque:true", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
...
Deno.test("RgbColor.prototype.toRgb() - mode:auto", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
...
Deno.test("RgbColor.prototype.toRgb({}) - mode:precision", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
...
Deno.test("RgbColor.prototype.toRgb({}) - mode:precision,discardAlpha:true", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
...
Deno.test("RgbColor.prototype.toRgb() - mode:uint8", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
...
Deno.test("RgbColor.prototype.toRgb() - mode:uint8,discardAlpha:true", () => {
  const c1 = RgbColor.fromRgb({ r: 0, g: 128, b: 64 });
