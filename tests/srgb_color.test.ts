...
// Deno.test("SRgb.SRgbColor.fromHsl({ h, s, l })", () => {
//   for (const c of r1Cases) {
//     const c0 = SRgb.SRgbColor.fromHsl({
//       h: Number(c.h),
//       s: Number(c.s),
//       l: Number(c.l),
//     });
...
// Deno.test("SRgb.SRgbColor.fromHsl({ h, s, l }, {})", () => {
//   const c1 = SRgb.SRgbColor.fromHsl({ h: 0, s: 0, l: 0, a: 0.5 }, {
//     ignoreAlpha: true,
//   });
//   assertStrictEquals(c1.alpha, 1);

//   const c2 = SRgb.SRgbColor.fromHsl({ h: 0, s: 0, l: 0, a: 0.5 }, {
//     ignoreAlpha: false,
//   });
